        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input value="<?php echo ($news["title"]); ?>" type="text" name="title" class="form-control" id="inputname" placeholder="请填写电影名称">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">上映时间:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($news["small_title"]); ?>" type="text" name="small_title" class="form-control" id="inputname" placeholder="请填写上映时间">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input value="<?php echo ($news["title"]); ?>" type="text" name="grade" class="form-control" id="inputname" placeholder="请填写评分">
              </div>
            </div>
