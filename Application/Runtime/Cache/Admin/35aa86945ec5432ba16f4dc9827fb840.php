        ...
        <div class="col-lg-6">
         ...
         <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input placeholder="请填写歌曲名称" type="text" name="music_name" class="form-control" id="inputname">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">影视名称:</label>
              <div class="col-sm-5">
                <input placeholder="请填写影视名称" type="text" name="movie_name" class="form-control" id="inputname">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input placeholder="请填写歌手" type="text" name="singer" class="form-control" id="inputname">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">时长:</label>
              <div class="col-sm-5">
                <input placeholder="请填写时长" type="text" name="time_long" class="form-control" id="inputname">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <textarea class="input js-editor" id="editor_content" name="content" rows="25" ></textarea>
              </div>
            </div>
