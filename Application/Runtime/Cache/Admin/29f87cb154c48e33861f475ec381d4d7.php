        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="movie_name" class="form-control" id="inputname" placeholder="请填写评论电影名称">
              </div>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="time" class="form-control" id="inputname" placeholder="请填写发表时间 如：2017-03-12">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="source" class="form-control" id="inputname" placeholder="请填写文章来源">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">内容:</label>
              <div class="col-sm-5">
                <textarea class="input js-editor" id="editor_content" name="content" rows="20" ></textarea>
              </div>
            </div>
            <div class="form-group">
